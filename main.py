...
def main():
    ...
    slider_mouse_strength = Slider(win=screen, x=25, y=350, width=200, height=20, min=200, max=12000, step=100, initial=10000, colour=COLOUR.UI_BUTTON_BACKGROUND, handleColour=COLOUR.UI_BUTTON_TEXT)
